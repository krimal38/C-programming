 ...
 *This function is same as free function. Frees all memory allocated with a Schedule and then the schedule itself.
  */
 ...
 */
/*
 *The function creates fully allocated struct.
 *The function also initialize count and the head pointer is set to NULL
 */
...
/*
 *This function is a helper method. This is basic LL which adds element at the list. 
 *It has been used in add function.  
 */
 ...
 */
/*
 *This function adds the given process to the schedule by its flags. 
 *It adds into three states STATE_CREATED, STATE_READY, STATE_DEFUNCT. 
 */
 ...
 */
/*
 *This fucntion finds the mathcing pid given by parameter from the Ready List. 
 *Once it has been found we remove the process from the Ready List. 
 * Then insert into Stopped List in Ascending PID order. 
 */
 ...
 */
/*
 *This function finds the pid from the Stopped List. 
 *Once found, it removes the process from the Stopped Lisit. 
 *
 */
 ...
 */
/*
 *This function matches the process with pid from the Defunct List. 
 *Once found. it will remove the process from the Defunct List. 
 *Then it will be set to STATE_TERMINATED
 */
 ...
 */
/*
 *This function creayes a new process with the given parameter. 
 * It sets all the parameters. For example if is_sudo is 1, set the PF_SUPERPRIV flag in the flags. 
 */
 ...
 */
/*
 *This function chooses the best process from the Ready List.
 *When the process is seleceted, it will remove the the procecss from LL and return the pointer. 
 *
 */
 ...
 */
/*
 *This fucntion returns the number of items in the given List. 
 */
 ...
 */
/*
 *This function frees all the lists, head, and command.
 *It has been done individually for each list. 
 *First the command is freed, then the head and List itself. 
 */
